            ...
            <div className="col-span-2 md:col-span-1 mt-4 md:mt-0">
              ...
              <form className="flex">
                <input
                  ...
                  className="bg-mosaic-dark border border-mosaic-blue/20 focus:border-mosaic-blue w-full sm:w-full md:w-3/4 px-3 py-1.5 md:px-4 md:py-2 text-sm focus:outline-none text-white placeholder-mosaic-gray"
                  style={{ direction: 'rtl' }}
                />
